...
-   **Factual Probability ($p_1$) **: There is a **`r p1*100`%** chance of an event exceeding $25^\circ C$ in our current, factual world (which is affected by the causal factor of human influence).
